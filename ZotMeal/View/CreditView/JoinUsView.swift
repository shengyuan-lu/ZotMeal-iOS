        ...
        NavigationView {
            ...
            ScrollView(showsIndicators: true) {
                ...
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    Text("ZotMeal runs on a total ownership / responsibility model. That means your work belongs to you. What you write stays in your personal portfolio and your own GitHub. This is very different from ICSSC or CTC which your work ultimately boosted the club leader's resume. Also there's no title like 'president' or 'vp' or 'manager'. We are a flat organization and we take pride in giving everyone credit and a platform to show their skills. For those interested in applying please contact shengyuan.lu.developer@gmail.com")
